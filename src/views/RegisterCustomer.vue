            ...
            <v-card class="mx-auto" style="max-width: 500px;">
                ...
                <v-form ref="form" v-model="isValid" class="pa-4 pt-6">
                    ...
                    <v-text-field v-model="password" :rules="[rules.password, rules.length(6)]" color="deep-purple"
                        ...
                        variant="filled"></v-text-field>
                    <v-text-field v-model="password_confirmation" :rules="[rules.password, rules.length(6)]" color="deep-purple"
                        counter="6" label="Konfirmasi Kata Sandi" style="min-height: 96px" type="password"
                        variant="filled"></v-text-field>
                </v-form>
                <v-divider></v-divider>
                <v-card-actions>
